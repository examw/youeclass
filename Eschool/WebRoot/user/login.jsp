	...
	function formSubmit()
	{
		if(!$("#username").val()||!$.trim($("#username").val()))
			...
			if(auto.length == 0){
				...
				data = {"username":$("#username").val(),"password":$("#password").val(),auto:auto.val()};
			}
			$.ajax({
				async:true,
				type:"post",
  		...
  		<div class="W_reg_form">
            ...
            <div class="">
                <div class="inp" style="margin-left:100px">
                	<label style="margin-left:10px"><input type="checkbox" name="isauto" value="1" style="margin:5px 5px"/>自动登录</label>
                	<a style="margin-left:70px" href='../user/findpwd.jsp'>忘记密码？</a>
              </div>
