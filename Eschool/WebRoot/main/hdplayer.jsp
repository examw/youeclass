			...
			success: function (result){
				...
				if(result.length!=0)
				{
					...
					for (var i=0;i<result.length;i++){
								...
								playIcon=childHtml+='<li><a href="?num='+i+'&gradeId='+gradeId+'&classId='+result[i].classId+'" title="'+unescape(result[i].classTitle)+'" classId="'+result[i].classId+'" class="'+playIcon+'"  target="_self"><span>'+(parseInt(childListNO)<10?"0"+parseInt(childListNO):parseInt(childListNO))+'、'+lname+'</span>'+isFree+'</a></li>';
						if(childHtml==''){
