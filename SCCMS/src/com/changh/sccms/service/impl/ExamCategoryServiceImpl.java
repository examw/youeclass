...
public class ExamCategoryServiceImpl implements ExamCategoryService {
	...
	public void saveExam(int id,String examName,String examUrl,String examDescription,String title,String examEname) throws Exception {
		...
		examCategory.setTitle(title);
		examCategory.setExamEname(examEname);
