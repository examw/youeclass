...
<div>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        	 <tr>
                ...
                <td align="left" class="l-table-edit-td">
                <input name="packageCategory.ptypeName" type="text" id="examEname" value="${exam.examEname}"  validate="{required:true,maxlength:15}" />
                </td>
           	 </tr>
           	 <tr>
           	 ...
           	 <tr>
                <td align="right" class="l-table-edit-td">考试tittle:</td>
                <td align="left" class="l-table-edit-td">
                <textarea cols="100" rows="3" class="l-textarea" id="examTitle" style="width:402px"  name="">${exam.title}</textarea>
                </td>
           	 </tr>
            <tr>
