...
<div>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        	 <tr>
                ...
                <td align="left" class="l-table-edit-td">
                <input name="packageCategory.ptypeName" type="text" id="examEname"  validate="{required:true,maxlength:15}" />
                </td>
           	 </tr>
           	 <tr>
           	...
           	<tr>
                ...
                <td align="left" class="l-table-edit-td">
                <textarea cols="100" rows="3" class="l-textarea" id="examTitle" style="width:402px"  name="">暂无简介</textarea>
                </td>
           	 </tr>
            <tr>
