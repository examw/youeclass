   ...
   $(function ()
    {
       ...
       var v = $("form").validate({
           ...
           submitHandler: function (form)
           {
           	...
           	var newId = $("#form1 input[name='newId']").val();
           	if(!newId)
           	{
           		$.ajax({
           			url:'${pageContext.request.contextPath}/new/checkName',
                	dataType:'json',
                	type:'post',
                	data:{"name":$("#form1 input[name='newTitle']").val()},
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td" colspan="4">
                	<textarea name="description" type="text" id="description" value="" style="width:560px">${news.description}</textarea>
                </td>
            </tr>
            <tr>
