    		 ...
    		 <div  position="center" title="资讯详细" >
    		 	 <form id="mainform">
				     ...
				     <div class="l-panel-search-item">
     					<span style="font-size: 14px; color: green;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;标题或关键字:</span>
    				</div>
    				<div class="l-panel-search-item">
        				<input class="l-text" type="text" id="content"  style="height: 16px;width:200px"/>
    				</div>
					<div class="l-panel-search-item">
...
<script type="text/javascript">
      ...
      { 
	    ...
	    function f_search(){
	    	var str = $("#content").val();
	    	grid.set('url', '${pageContext.request.contextPath}/new/findAll?provinceId='+provinceId+'&examId='+examId+"&content="+str);
	    }
        $(function ()
        {
