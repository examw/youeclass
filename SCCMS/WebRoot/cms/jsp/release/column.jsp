  ...
  <div id="layout1">
    ...
    <center>
   	<table cellpadding="0" cellspacing="0" class="l-table-edit">
   		<tr>
            	<td><input type="button" value="发布课程" class="l-button l-button-reset" onclick="f_release('发布课程',0)"/></td>
            	<td><input type="button" value="预览课程" class="l-button l-button-submit" onclick="f_preview()"/></td>
        </tr>  
        <tr>
            	<td><input type="button" value="发布资讯" class="l-button l-button-reset" onclick="f_release('发布资讯',1)"/></td>
            	<td><input type="button" value="预览资讯" class="l-button l-button-submit" onclick="f_preview()"/></td>
        </tr>  
   	</table>
    </center>
    </div>
    ...
    //发布
     function f_release(title,category){
    	...
    	return;
     	...
     	var text = getChecked();
     	window.loginWin=$.ligerDialog.open({ 
			          	  	url: '${pageContext.request.contextPath}/cms/jsp/release/demo.jsp?examId='+text+'&category='+category,
			          	    title:title,
			          	    isHidden: false,
			          	    icon: 'images/Program Files Folder.png',
