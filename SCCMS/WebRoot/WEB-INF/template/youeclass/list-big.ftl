...
<script type="text/javascript">BAIDU_CLB_fillSlot("850535");</script>
    <div class="daohang">
    	<ul>
        	<li><a href="http://www.youeclass.com/" target="_blank" title="优异网校"><img src="/youeclass/images/logo.png" height=52 alt="优异网校" /></a></li>
...
<div id="cbox">
	...
	<div class="listtle">${newsexam.newsexam.cname}${newclass.classCname}<span style="float:right"><a href="${examBig.examEname}">更多</a></span></div>
    <div class="listcon">
        	<ul>
            	<li></li>
	...
	<#list children as exam>
	<#if exam.news?exists&&(exam.news?size>0)> 
    <div class="listtle"><a href="${exam.examEname}">${exam.examName}</a><span style="float:right"><a href="${exam.examEname}">更多</a></span></div>
    <div class="listcon">
        	<ul>
            	<li></li>
            	<#list exam.news as n><li>·<a href="/${n.exam.examEname}/${n.province.provinceEname}/${n.newclass.classEname}/${n.newId?c}/" title="${n.subTitle}" target="_blank">${n.newTitle}</a><span>${n.addTime?date}</span></li></#list>
                <li></li>
			</ul>
	</div>
	</#if>
