...
<title>2014年${exam.examName}考试辅导,优异网校高端培训助你一次通过${exam.examName}考试!</title>
<meta name="keywords" content="${exam.examName}网校,${exam.examName}培训,${exam.examName}网络课堂,${exam.examName}课件" />
<meta name="description" content="2014年${exam.examName}专业考前辅导，就来优异网校！高清视频，便捷的手机客户端，全名师授课，最优质的服务，最精准的考前资料，打造${exam.examName}培训最高的通过率！" />
...
$(function(){
			...
			$.post("/user/stuName",function(data){
			 username=data;
			},"json")
...
<div class="bttit mar20"><span>多种辅导体系，满足不同的需求。顶级名师战略，确保学习效果</span></div>
...
<!--视频模块videoBg开始-->
 <script src="../js/jwplayer.min.js" type="text/javascript"></script>
   ...
   var thePlayer; 
  $(function(){  
     thePlayer = jwplayer("playerContent").setup({
			    flashplayer: '/js/youeclass.swf',			   
               			'file': "${exam.examUrl?default("2.flv")}" ,
				width: '100%',
				height: '100%',
				controlbar: 'bottom',
